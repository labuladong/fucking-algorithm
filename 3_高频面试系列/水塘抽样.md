...
[daiyi-guizhou](https://github.com/daiyi-guizhou/) 提供 leetcode 382  python 解法代码
```py
...
class Solution(object):
    ...
    def getRandom(self):
        ...
        #         self._reservoir.append(cur.val)
        #     else:
        #         random_k = random.randint(1,self._count)
        #         if random_k <= self.size:
        #             self._reservoir[random_k-1]=cur.val
        #     cur = cur.next
        # return self._reservoir[-1]
```

[daiyi-guizhou](https://github.com/daiyi-guizhou/) 提供 leetcode 398  python 解法代码
```py
class Solution(object):
    ...
    def pick(self, target):
        ...
        # for cur,i in enumerate(self.node):
        #     if i == target:
        #         self._count = self._count + 1
        #         if self._count <= self.size:
        #             self._reservoir.append(cur)
        #         else:
        #             random_k = random.randint(1,self._count)
        #             if random_k <= self.size:
        #                 self._reservoir[random_k-1]=cur
        # return self._reservoir[-1]
