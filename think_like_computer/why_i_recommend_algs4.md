...
This is why I don't recommend CLRS (alias _Introduction to Algorithms_) as a starting point. It's comprehensive, mathematically rigorous, and excellent as a reference—but the depth of proofs and breadth of ADTs can overwhelm beginners. Consider it a resource to solidify your understanding after building intuition from practical resources like this one. 
