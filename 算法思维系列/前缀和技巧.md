...
![](https://labuladong.online/algo/images/前缀和/4.png)
...
除了本文举例的基本用法，前缀和数组经常和其他数据结构或算法技巧相结合，我会在 [前缀和技巧高频习题](https://labuladong.online/algo/fname.html?fname=前缀和习题) 中举例讲解。
