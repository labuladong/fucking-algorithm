...
理解本文能保证你写出正确的二分查找的代码，但实际题目中不会直接让你写二分代码，我会在 [二分查找的运用](https://labuladong.github.io/article/fname.html?fname=二分运用) 和 [二分查找的更多习题](https://labuladong.github.io/article/fname.html?fname=二分习题) 中进一步讲解如何把二分思维运用到更多算法题中。
