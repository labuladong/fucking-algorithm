...
我会在 [单调栈的几种变体及习题](https://labuladong.github.io/article/fname.html?fname=单调栈习题) 对比单调栈的几种其他形式，并在 给出单调栈的经典例题。更多数据结构设计类题目参见 [数据结构设计经典习题](https://labuladong.github.io/article/fname.html?fname=设计习题)。
