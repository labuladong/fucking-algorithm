...
![](https://labuladong.online/algo/images/单调队列/window.png)
...
![](https://labuladong.online/algo/images/单调队列/2.png)
...
这里就用到了 [算法时空复杂度分析使用手册](https://labuladong.online/algo/essential-technique/complexity-analysis/) 中讲到的摊还分析：
