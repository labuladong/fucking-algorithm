...
我将在 [单调队列通用实现及应用](https://labuladong.github.io/article/fname.html?fname=单调队列习题) 中给出单调队列的通用实现和经典习题。更多数据结构设计类题目参见 [数据结构设计经典习题](https://labuladong.github.io/article/fname.html?fname=设计习题)。
