...
**[我的刷题插件](https://mp.weixin.qq.com/s/qQAfGW6CJ-lE73Qf_w9skw) 更新了所有值得一做的二叉树题目思路，全部归类为上述两种思路**，你如果按照插件提供的思路解法过一遍二叉树的所有题目，不仅可以完全掌握递归思维，而且可以更容易理解高级的算法：
...
**[我的刷题插件](https://mp.weixin.qq.com/s/qQAfGW6CJ-lE73Qf_w9skw)对于这类考察后序遍历的题目也有特殊的说明**，并且会给出前置题目，帮助你由浅入深理解这类题目：
...
对于这类问题，[我的刷题插件](https://mp.weixin.qq.com/s/qQAfGW6CJ-lE73Qf_w9skw)也会同时提供递归遍历和层序遍历的解法代码：
