...
[MoguCloud](https://github.com/MoguCloud) 提供 House Robber I Python 解法代码：

```py
class Solution:
    def rob(self, nums: List[int]) -> int:
        dp_i_1 = 0 # 第 i + 1 间房子最多能抢的钱 
        dp_i_2 = 0 # 第 i + 2 间房子最多能抢的钱
        dp_i = 0   # 第 i 间房子最多能抢的钱
        for n in nums:
...
[MoguCloud](https://github.com/MoguCloud) 提供 House Robber II Python 解法代码：
...
class Solution:
    def rob(self, nums: List[int]) -> int:
        ...
        if n == 1:
            return nums[0]
        return max(self.rob_range(nums, 1, n-1),
...
[MoguCloud](https://github.com/MoguCloud) 提供 House Robber III Python 解法代码：
...
class Solution:
    ...
    def dp(self, root: TreeNode) -> list:
        """
        arr[0] 表示不抢 root 的话，得到的最大钱数
        arr[1] 表示抢 root 的话，得到的最大钱数 
        """
